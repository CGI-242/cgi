...
function InfoRow({ label, value, colors }: { label: string; value: string; colors: any }) {
  return (
    <View style={{ flexDirection: "row", marginTop: 8, paddingLeft: 8 }}>
      <Text style={{ fontSize: 14, color: colors.textMuted, lineHeight: 22, fontFamily: fonts.medium, fontWeight: fontWeights.medium, width: 200 }}>
        {label}
      </Text>
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={{ alignItems: "center", padding: 20, paddingBottom: 60 }}>
        ...
        <View style={{
          ...
          <Text style={{ fontSize: 17, fontFamily: fonts.bold, fontWeight: fontWeights.bold, color: GOLD, marginTop: 28, marginBottom: 10 }}>
            2. Directrice de la publication
          </Text>
          <Text style={{ fontSize: 14, color: colors.text, lineHeight: 24, fontFamily: fonts.regular, fontWeight: fontWeights.regular, paddingLeft: 8 }}>
