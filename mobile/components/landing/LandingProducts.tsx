          ...
          return (
            ...
            <Card
              ...
              style={{
                ...
                flexGrow: 1,
                backgroundColor: product.available ? "rgba(200,160,60,0.04)" : "#f9fafb",
                borderWidth: product.available ? 2 : 1,
                borderColor: product.available ? GOLD : "rgba(0,0,0,0.06)",
                borderRadius: 16,
            ...
            >
              ...
              <View
                style={{
                  ...
                  borderRadius: 20,
                  backgroundColor: product.available ? "rgba(22,163,74,0.1)" : "rgba(156,163,175,0.12)",
                }}
              >
                <Text
                  style={{
